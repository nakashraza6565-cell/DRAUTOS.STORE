    ...
    <div class="card-body">
      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="sku" type="text" name="sku" placeholder="Enter SKU" value="{{$product->sku}}" class="form-control">
                    @error('sku')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="barcode" type="text" name="barcode" placeholder="Enter Barcode" value="{{$product->barcode}}" class="form-control">
                    @error('barcode')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input id="purchase_price" type="number" step="0.01" name="purchase_price" placeholder="Enter purchase price" value="{{$product->purchase_price}}" class="form-control">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input id="packaging_cost" type="number" step="0.01" name="packaging_cost" placeholder="Enter packaging cost" value="{{$product->packaging_cost}}" class="form-control">
        ...
        <div class="row">
            <div class="col-md-3">
                 <div class="form-group">
                    ...
                    <input id="wholesale_price" type="number" step="0.01" name="wholesale_price" placeholder="Wholesale Price" value="{{$product->wholesale_price}}" class="form-control">
            ...
            <div class="col-md-3">
                 <div class="form-group">
                    ...
                    <input id="retail_price" type="number" step="0.01" name="retail_price" placeholder="Retail Price" value="{{$product->retail_price}}" class="form-control">
                    @error('retail_price')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-3">
                 <div class="form-group">
                    ...
                    <input id="walkin_price" type="number" step="0.01" name="walkin_price" placeholder="Walk-in Price" value="{{$product->walkin_price}}" class="form-control">
                    @error('walkin_price')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-3">
                 <div class="form-group">
                    ...
                    <input id="salesman_price" type="number" step="0.01" name="salesman_price" placeholder="Salesman Price" value="{{$product->salesman_price}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="suppliers[]" class="form-control selectpicker" multiple data-live-search="true">
                        @php 
                            ...
                            // Fallback for old single supplier_id if suppliers relationship not populated yet or empty
                            if(empty($supplier_ids) && $product->supplier_id) {
                ...
                <div class="form-group">
                    ...
                    <select name="warehouse_id" class="form-control">
                        ...
                        @foreach($warehouses as $warehouse)
                            <option value="{{$warehouse->id}}" {{(($product->warehouse_id==$warehouse->id)? 'selected' : '')}}>{{$warehouse->name}} ({{$warehouse->location}})</option>
                        @endforeach
                    </select>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" name="rack_number" class="form-control mt-2" placeholder="Rack Number" value="{{$product->rack_number}}">
                    </div>
                    <div class="col-md-6">
                         <input type="text" name="shelf_number" class="form-control mt-2" placeholder="Shelf Number" value="{{$product->shelf_number}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <input type="hidden" name="low_stock_threshold" value="{{$product->low_stock_threshold ?? 5}}">
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="weight">Weight (per unit)</label>
                    <input id="weight" type="number" step="0.01" name="weight" value="{{$product->weight}}" class="form-control" placeholder="e.g. 0.5">
                    @error('weight')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="batch_number" value="{{$product->batch_number}}" class="form-control" placeholder="Enter Batch Number">
                </div>
            </div>
        </div>
        ...
        <div class="row">
             <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="size[]" class="form-control" placeholder="Size (e.g. S, M, L or separate by comma)" value="{{$product->size}}">
