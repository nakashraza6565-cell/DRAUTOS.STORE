...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Global Analytics</h1>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Sales (All Time)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. {{number_format(\App\Models\Order::where('status','delivered')->sum('total_amount'), 2)}}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Profit (Est. 30%)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. {{number_format(\App\Models\Order::where('status','delivered')->sum('total_amount') * 0.3, 2)}}</div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <canvas id="analyticsAreaChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    // Placeholder charts
    var ctx = document.getElementById("analyticsAreaChart");
    ...
    var ctxPie = document.getElementById("analyticsPieChart");
