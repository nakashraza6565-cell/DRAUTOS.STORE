...
<head>
    ...
    <title>Danyal Autos Co. | Sign In</title>
...
<body>
    ...
    <div class="brand-panel">
        <div class="brand-panel-inner">
            ...
            <!-- DR Logo (exact SVG from frontend header) -->
            ...
            <h2 class="brand-headline">
                ...
                TRUCK PARTS <span>|</span> B2B
            </h2>
            <p class="brand-sub">
                Your trusted wholesale partner for heavy-duty reliability.<br>
                Sign in to access exclusive pricing and bulk ordering.
            </p>

            <div class="brand-badges">
                <div class="brand-badge"><i class="fas fa-shield-alt"></i> Secure Access</div>
                <div class="brand-badge"><i class="fas fa-truck"></i> Wholesale Pricing</div>
                <div class="brand-badge"><i class="fas fa-clock"></i> 24/7 Orders</div>
            </div>
        </div>
    </div>
    ...
    <div class="form-panel">
        <div class="form-inner">
            ...
            <p class="form-subtitle">Sign in to your Customer Access Portal</p>

            {{-- Notifications --}}
            @if(session('success'))
                <div class="alert-success"><i class="fas fa-check-circle mr-2"></i>{{ session('success') }}</div>
            @endif
            @if(session('error'))
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-wrap {{ $errors->has('email') ? 'is-invalid' : '' }}">
                    ...
                    <input type="text" class="form-input"
                           ...
                           placeholder="Email or 03XXXXXXXXX" required autofocus>
                </div>
                @error('email')
                ...
                {{-- Password --}}
                <label class="form-label" style="margin-top: 4px;">Password</label>
            ...
            <a href="{{ route('home') }}" class="back-to-shop">
                <i class="fas fa-store"></i> Browse Store as Guest
            </a>
        </div>

        <div class="copyright">&copy; {{ date('Y') }} Danyal Autos Co. All rights reserved.</div>
    </div>
