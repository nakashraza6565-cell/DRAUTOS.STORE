...
<body>
    ...
    <div id="backpage-wrapper" style="position: relative; background: #fff; padding: 10px; font-family: 'Helvetica', 'Arial', sans-serif;">
        <!-- Branding Header -->
        <table style="width: 100%; background: #062038; border-bottom: 3px solid #facc15; padding: 8px 12px; margin-bottom: 12px; color: #fff; border-collapse: collapse;">
            <tr>
                <td style="width: 55%; vertical-align: middle;">
                    <table style="border: none; border-collapse: collapse; width: 100%;">
                        <tr>
                            ...
                            <td style="vertical-align: middle; border: none; padding-left: 8px; color: #fff;">
                                <div style="font-size: 15px; font-weight: bold; letter-spacing: 0.5px;">{{ strtoupper($settings->title ?? 'Danyal Autos') }}</div>
                                <div style="font-size: 8px; color: #a3b1c6; text-transform: uppercase; letter-spacing: 1px; margin-top: 1px;">Spare Parts Portal</div>
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="width: 45%; text-align: right; font-size: 8.5px; vertical-align: middle; line-height: 1.3; color: #fff;">
