...
<div class="container-fluid premium-bg" style="padding: 1rem;">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-lg-6 mb-3 mb-lg-0 text-center text-lg-left">
            ...
            <!-- Quick Expense Button (Mobile Only) -->
            <button data-toggle="modal" data-target="#quickExpenseModal" class="btn btn-sm rounded-pill px-3 shadow-sm font-weight-bold mr-0 mr-md-2 w-100 w-md-auto mb-2 mb-md-0 d-md-none" style="font-size: 11px; height: 32px; background: #083259; color: #facc15; border: 1px solid #facc15;">
                <i class="fas fa-minus-circle mr-1"></i> EXPENSE
            </button>

            <!-- Quick Bilty Button (Mobile Only) -->
