                        ...
                        @foreach($purchase_orders as $po)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('purchase-orders.thermal',$po->id)}}" target="_blank" class="btn btn-warning btn-sm rounded-circle" title="Print Both Receipts"><i class="fas fa-print text-white"></i></a>
