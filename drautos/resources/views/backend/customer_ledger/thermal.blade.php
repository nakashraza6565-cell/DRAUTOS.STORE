...
<body>
    ...
    <div class="info-grid text-center">
        <div class="bold" style="font-size: 14px; margin-bottom: 5px;">CUSTOMER STATEMENT</div>
        <div class="info-row">
            <span>Customer: <strong>{{ strtoupper($user->name) }}</strong></span>
        </div>
        <div class="info-row">
    ...
    <div class="balance-block">
        ...
        <div class="final-balance">Rs. {{ number_format($user->current_balance, 0) }}</div>
    </div>
