...
">
    ...
    <a href="{{route('admin')}}" class="navbar-brand d-flex align-items-center mr-4" style="text-decoration: none;">
        <svg width="36" height="32" viewBox="0 0 75 65" xmlns="http://www.w3.org/2000/svg" style="flex-shrink:0;">
        ...
        <div class="ml-2 d-none d-lg-block" style="line-height:1;">
            <div style="font-family:'Montserrat',sans-serif; font-weight:900; font-size:13px; color:#083259; letter-spacing:0;">DANYAL AUTOS</div>
            <div style="font-family:'Inter',sans-serif; font-size:8px; font-weight:700; color:#a3b1c6; text-transform:uppercase; letter-spacing:1px;">Admin Portal</div>
        </div>
    </a>
    ...
    <ul class="navbar-nav ml-auto align-items-center">
      ...
      <!-- Push Notifications -->
      <li class="nav-item mx-1">
        <a class="nav-link d-flex align-items-center justify-content-center" href="#" id="onesignal-manual-subscribe"
           style="width:36px; height:36px; border-radius:8px; background:#fef3c7; color:#d97706;" title="Enable Notifications">
