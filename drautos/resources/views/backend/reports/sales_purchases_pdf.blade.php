...
<body>
    <div class="header">
        ...
        <div class="report-title">Sales & Purchases Comparison Report</div>
    </div>
    ...
    <div class="summary-box">
        <table class="summary-table">
            <tr>
                <td class="summary-label">Total Customer Sales:</td>
                <td class="summary-value text-warning">Rs. {{ number_format($totalSales) }}</td>
            </tr>
            <tr>
                <td class="summary-label">Total Cost of Incoming Goods:</td>
                <td class="summary-value" style="color: #64748b;">Rs. {{ number_format($totalPurchases) }}</td>
            </tr>
            <tr style="border-top: 1px solid #cbd5e1;">
                <td class="summary-label" style="padding-top: 8px;">Stock Flow Difference:</td>
                <td class="summary-value {{ ($totalSales - $totalPurchases) >= 0 ? 'text-success' : 'text-danger' }}" style="padding-top: 8px; font-size: 16px;">
