                ...
                <div class="col-lg-4 col-md-4 col-8">
                    <div class="logo m-0">
                        <a href="{{route('home')}}" class="d-flex align-items-center" style="text-decoration: none;">
                            ...
                            <div style="width: clamp(45px, 12vw, 70px); margin-right: clamp(8px, 3vw, 15px); flex-shrink: 0; display: flex; align-items: center;">
                                <svg width="100%" height="auto" viewBox="0 0 75 65" xmlns="http://www.w3.org/2000/svg" style="display: block;">
                            ...
                            <!-- Logo Text -->
                            <div class="d-flex flex-column justify-content-center" style="white-space: nowrap;">
                                <h3 style="color: #031430; font-size: clamp(14px, 4vw, 26px); font-weight: 900; letter-spacing: -0.5px; margin: 0; line-height: 1;">DANYAL AUTOS</h3>
                                <span style="color: #64748b; font-size: clamp(7px, 1.8vw, 13px); font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 4px;">PREMIUM TRUCK PARTS B2B</span>
                            </div>
                        </a>
                    </div>
                </div>
