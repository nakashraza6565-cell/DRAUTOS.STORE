                ...
                <div class="col-lg-4 col-md-4 col-8">
                    <div class="logo m-0">
                        <a href="{{route('home')}}" class="d-flex align-items-center" style="text-decoration: none;">
                            <!-- Intertwined DR Graphic (Revue Font rendered as image) -->
                            <div style="width: 70px; height: 60px; margin-right: 15px; flex-shrink: 0;">
                                <img src="{{asset('frontend/img/dr_logo_revue.png')}}" alt="DR Logo" style="width: 100%; height: 100%; object-fit: contain;">
                            </div>
                            <!-- Logo Text -->
