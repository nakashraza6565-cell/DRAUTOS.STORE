                ...
                <div class="col-auto">
                    <div class="logo m-0">
                        <a href="{{route('home')}}" class="d-flex align-items-center" style="text-decoration: none;">
                            ...
                            <div style="width: 75px; height: 65px; margin-right: 15px; flex-shrink: 0; display: flex; align-items: center;">
                            ...
                            <!-- Logo Text -->
                            <div class="d-flex flex-column justify-content-center" style="white-space: nowrap; padding-top: 2px;">
                                <h3 style="color: #031430; font-family: 'Montserrat', 'Inter', sans-serif; font-size: 21px; font-weight: 900; letter-spacing: 0px; margin: 0; line-height: 1;">DANYAL AUTOS</h3>
