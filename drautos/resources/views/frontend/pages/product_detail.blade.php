									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat mt-1">Sub Category :<a href="{{route('product-sub-cat',[$product_detail->cat_info->slug ?? '#',$product_detail->sub_cat_info->slug ?? '#'])}}">{{$product_detail->sub_cat_info->title ?? 'N/A'}}</a></p>
												@endif
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		...
																		<div class="rating-des">
																			<h6>{{$data->user_info->name ?? 'Guest User'}}</h6>
																			<div class="ratings">
