...
class Post extends Model
{
    ...
    public static function getAllPost(){
        return Post::with(['cat_info','author_info'])->orderBy('id','DESC')->paginate(5000);
    }
    ...
    //     // return Product::where('cat_id',$id)->where('child_cat_id',null)->paginate(5000);
    // }

    // public static function getBlogByCategory($id){
    //     return Post::where('post_cat_id',$id)->paginate(5000);
    // }
    public static function getBlogByTag($slug){
        // dd($slug);
        return Post::where('tags',$slug)->paginate(5000);
    }
